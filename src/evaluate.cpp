...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    ...
    { S(-37,-37), S(-21,-15), S(  3,  8), S(  3, 18), S( 14, 34), S( 22, 53), // Elephant
      S( 26, 61), S( 40, 69), S( 43, 77), S( 49, 92), S( 58, 92), S( 61,103),
      S( 65,119), S( 66,121), S( 67,129), S( 69,119), S( 71,133), S( 74,135),
      S( 83,141), S( 89,142), S( 93,152), S( 97,168), S(111,183) },
