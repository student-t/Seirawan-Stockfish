...
enum Value : int {
  ...
  PawnValueMg     = 172,   PawnValueEg     = 255,
  KnightValueMg   = 784,   KnightValueEg   = 806,
  BishopValueMg   = 878,   BishopValueEg   = 853,
  RookValueMg     = 1338,  RookValueEg     = 1337,
  HawkValueMg     = 1969,  HawkValueEg     = 2210,
  ElephantValueMg = 2129,  ElephantValueEg = 2533,
  QueenValueMg    = 2235,  QueenValueEg    = 2677,
